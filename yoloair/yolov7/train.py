...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='yolov7/coco128.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='data/hyps/hyp.scratch.p5.yaml', help='hyperparameters path')
